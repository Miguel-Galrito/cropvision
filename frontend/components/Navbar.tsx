      ...
      <div className="flex items-center space-x-2 sm:space-x-2.5 shrink-0">
        ...
        {onToggleTheme && (
          <button
            ...
            className={`hidden sm:flex items-center space-x-1.5 px-2.5 py-1.5 rounded-xl border text-xs font-bold transition-all shadow-sm ${
              isLight
        ...
        {onLanguageChange && (
          <button
            ...
            className={`hidden sm:flex items-center space-x-1 px-2.5 py-1.5 rounded-xl border text-xs font-bold transition-all shadow-sm ${
              isLight
                ? 'bg-slate-100 hover:bg-slate-200 border-slate-300 text-slate-800'
        ...
        {onOpenParcelUploader && (
          ...
          >
            ...
            <span>{t.importParcelBtn || t.sigPolygon}</span>
          </button>
        )}
